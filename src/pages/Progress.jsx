...
const MODULES = [
  ...
  { module: 'AI Design Center', area: 'Design', status: 'planned', ref: 'BOARD-013 · VISION §7',
    desc: 'The unifying immersive experience for the Brije design office, entered through a rendered lobby with doors to each studio. Gate: the BOARD-013 pipeline spike (plan→3D tooling, web engine vs pixel-streaming, SKU-mappable material libraries) — kill the riskiest unknown before any studio build.' },
